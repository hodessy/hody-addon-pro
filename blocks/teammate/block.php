...
<style>
    ...
    <?php if ($teamShowHideIconLabel) : else:  ?>
        .uniqueclass .hody-team-social-icons .hody-addon-social-link span:not(.screen-reader-text) {
        display: none;
    }
     <?php endif;?>

.uniqueclass .hody-team-profile-image-card:before {
    background-color: <?php echo block_field('team-hover-bg-color')?>;
}

</style>
<div style="border-radius: <?php echo $teamBorderRadius;?>;" class="hoddy-addon-team-block default-team-block-style">
