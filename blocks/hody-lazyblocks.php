...
lazyblocks()->add_block( array(
    'id' => 248,
    'title' => 'VideoLightbox',
    'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8 12.5v-9l6 4.5-6 4.5z" /></svg>',
    'keywords' => array(
        0 => 'Video',
        1 => 'Popup',
        2 => 'Lightbox Video',
    ),
    'slug' => 'lazyblock/video-lightbox',
    'description' => '',
    'category' => 'widgets',
    'category_label' => 'widgets',
    'supports' => array(
    ...
    'controls' => array(
        'control_0e3b0e4f3b' => array(
            'type' => 'url',
            'name' => 'vlb-video-source',
            'default' => '#',
            'label' => 'Video Source',
        ...
        'control_vlb_content_align' => array(
            'type' => 'select',
            'name' => 'vlb-content-align',
            'default' => 'start',
        ...
        'control_59e885482c' => array(
            'type' => 'color',
            'name' => 'vlb-icon-box-color',
       ...
       /* 'control_72ab8540f3' => array(
            'type' => 'text',
            'name' => 'vlb-icon-box-border-width',
            'default' => '2',
        ...
        'control_319a0e41f3' => array(
            'type' => 'range',
            'name' => 'vlb-icon-box-radius',
            'default' => '50',
            'label' => 'Box Radius',
            'help' => '',
            'child_of' => '',
        ...
        'control_vlb_box_border_color' => array(
            'type' => 'color',
            'name' => 'vlb-box-border-color',
            'default' => '',
            'label' => 'Border Color',
            'help' => '',
            'child_of' => '',
        ...
        'control_e699cf4d03' => array(
            'type' => 'select',
            'name' => 'vlb-box-border-style',
            'default' => 'none',
        ...
        'control_7dea874d8b' => array(
            'type' => 'range',
            'name' => 'vlb-box-border-size',
            'default' => '0',
