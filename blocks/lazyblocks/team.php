...
<div class="hody-team-content hody-team-profile-image-card">
    <div class="hody-team-content-hover-body">
<h5><?php echo $teamName ?></h5>
<p><?php echo $teamSpecialty ?></p>
<ul class="hody-team-social-icons">
<?php if ( !empty ( $teamProfileFacebook )) {  ?> 
<li class="hody-addon-social-link wp-block-social-link">
